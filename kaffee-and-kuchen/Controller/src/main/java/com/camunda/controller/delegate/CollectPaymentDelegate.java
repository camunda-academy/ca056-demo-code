...
public class CollectPaymentDelegate implements JavaDelegate {
    ...
    @Autowired
    public CollectPaymentDelegate(OrderProcessor orderProcessor) {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        processor.newOrder().send(message(order));
        log.info("Online Order Sent to queue for payment: " + orderInfo);
    }
